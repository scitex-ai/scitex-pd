...
# (project=scitex-pd, owner=ywatanabe1989, repo=scitex-pd,
...
TMPDIR="/tmp/publish-scitex_pd-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-pd dist/* uploaded to PyPI via manual OIDC trusted publishing"
